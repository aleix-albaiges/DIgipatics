...
- Mapeo mask ↔ clases: sicap_mapping (``build_mask_lut``, ``--gg5-gray-min``, ``clean_all_speckles``).
...
DEFAULT_CONFIG = {
    ...
    # Componentes de cualquier clase con menos pixeles → reasignar al vecino más frecuente (0 = disabler limpieza).
    "mask_clean_min_area": 16,
}

# ─────────────────────────────────────────────────────────────────────────────
# Dataset  — LUT vía build_mask_lut(gg5_gray_min) + optional clean_all_speckles (sicap_mapping)
# ─────────────────────────────────────────────────────────────────────────────
...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="N",
        help="Reasignar al vecino más frecuente los componentes de cualquier clase con menos de N pixeles (default config: 16; 0 = disabler).",
    )
