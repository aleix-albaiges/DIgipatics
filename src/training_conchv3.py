...
def compute_sample_weights(image_names: list, masks_dir: Path):
    """Sobremuestreo: tiles con GG5 → 2.5×; only GG4 → 1.3×; rest 1×.
...
def main():
    ...
    parser.add_argument("--fold", type=str, default=None, choices=["Val1", "Val2", "Val3", "Val4"], help="Ejecutar only un fold en específico (ej. Val1). Si no se indica, se ejecutan los 4.")
    parser.add_argument(
        "--output-dir",
        type=str,
        default=None,
